...
const FolderContentViewBody = ({ notes, handleSearch }: FolderContentViewBodyProps) => {
    ...
    <>
      <div className='w-full p-2 flex flex-col gap-2'>
        ...
        <div className='flex w-full gap-2'>
          ...
          {/* ---------------------- */}
          {/* <Tooltip direction='bottom' text='implement this feature after finilizing the logic for the note tag.' isVisible={true} className=''> */}
